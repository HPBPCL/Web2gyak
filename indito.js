...
//     KONFIG
// ------------------------------
const PORT = process.env.PORT || 3000; // A Render adja a portot
const APP_PATH = '';                   // A gyökérben fut, nincs /app130 mappa
const DB_USER = 'studb130';
const DB_PASS = 'abc123';              // VIGYÁZZ! Ez látszani fog GitHubon!
const DB_NAME = 'db130';

// --- ADATBÁZIS KAPCSOLAT (KÜLSŐ) ---
const pool = mysql.createPool({
    host: '143.47.98.96',      // <--- FONTOS: Iskolai publikus IP!
    port: 3306,                // <--- FONTOS: MySQL port!
    user: DB_USER,
    password: DB_PASS,
    database: DB_NAME,
